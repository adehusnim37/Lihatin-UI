          ...
          <div className="space-y-8 text-sm sm:text-base text-muted-foreground leading-relaxed">
            <section>
              <p className="text-foreground font-medium mb-4">
                Welcome to Lihat.in. By accessing and using our service, you agree to be bound by
            ...
            <section>
              ...
              <p>
                Lihat.in provides URL shortening, link management, and analytics services. We allow
                users to create shortened URLs, track clicks, and manage links for personal or
                commercial use.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  Link to content that is illegal, abusive, harassing, or violates any third
                  party&apos;s rights.
                </li>
                <li>Attempt to bypass any limitations or security measures of the Service.</li>
                <li>
                  Use the Service for any automated scraping or mass link creation without explicit
                  permission or API access.
                </li>
              </ul>
              <p className="mt-3">
                We reserve the right to disable any link or terminate any account that violates
            ...
            <section>
              ...
              <p>
                To access advanced features, you may need to register for an account. You must
            ...
            <section>
              ...
              <p>
                While we strive to provide accurate analytics and link tracking data, we do not
                guarantee the absolute accuracy or completeness of the data provided through our
                Service.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-lg font-semibold text-foreground mb-3">
                5. Limitation of Liability &amp; Modifications
              </h2>
              <p>
                Lihat.in shall not be liable for any indirect, incidental, special, consequential or
                punitive damages resulting from your access to or use of the Service. We reserve the
