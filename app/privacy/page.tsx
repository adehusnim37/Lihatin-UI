      ...
      <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-8 text-sm sm:text-base text-muted-foreground leading-relaxed">
            <section>
              <p className="text-foreground font-medium mb-4">
                At Lihat.in, we take your privacy seriously. This policy explains what information
                we collect, why we collect it, and how we protect it when you use our website and
                services.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p>
                    When you register, we collect your email address, name, and password. This is
                    required to provide secure access to your link management dashboard.
                  </p>
                </div>
                <div>
                  <h3 className="font-medium text-foreground">Link Tracking Data</h3>
                  <p className="mb-2">
                    When users click your short links, we collect data to provide you with
            ...
            <section>
              ...
              <p>
                We <strong>never sell or rent</strong> your personal information. We only share
                information with trusted third-party Service Providers (such as our hosting
                infrastructure on Cloudflare or email delivery services) who need access to perform
                tasks on our behalf. We may also disclose information when strictly required by law
            ...
            <section>
              ...
              <p>
                ...
                and the data collected through your links. We utilize modern encryption and secure
                server infrastructures. However, please be aware that no method of transmission over
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-muted-foreground">
            Want to know the rules of using our service? Read our{" "}
            <Link
              href="/terms"
