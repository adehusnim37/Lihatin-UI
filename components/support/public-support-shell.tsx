  ...
  return (
    <div className="flex min-h-dvh flex-col bg-slate-50/70">
        ...
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between gap-4 px-4 sm:px-6">
          <Link href="/support" className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground">Public help center</p>
            </div>
          </Link>

          <nav className="flex items-center gap-1" aria-label="Support navigation">
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 sm:px-6 sm:py-10">
        <div className={centered ? "mx-auto mb-7 max-w-xl text-center" : "mb-7 max-w-2xl"}>
      ...
      <footer className="border-t bg-background">
        <div className="mx-auto flex max-w-5xl flex-col gap-1 px-4 py-5 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-6">
          ...
          <p>Lihatin Support will never ask for your password or OTP in chat.</p>
        </div>
      </footer>
    </div>
  );
