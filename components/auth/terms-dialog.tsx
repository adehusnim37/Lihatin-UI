    ...
    <Dialog>
      ...
      <DialogContent className="max-w-2xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>Last updated: November 14, 2025</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4 text-sm">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using Lihatin, you accept and agree to be bound by the terms and
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Your use of Lihatin is also governed by our Privacy Policy. Please review our
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-2">You may not use Lihatin:</p>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                Lihatin shall not be liable for any indirect, incidental, special, consequential, or
